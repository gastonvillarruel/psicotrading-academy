...
export default async function StudentCampusPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {courses.length === 0 ? (
        <div className="bg-white rounded-3xl border border-gray-100 p-8 sm:p-16 text-center shadow-lg max-w-2xl mx-auto">
          ...
          <Link
            href="/"
            className="inline-block w-full sm:w-auto px-6 py-3.5 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-xl shadow-lg shadow-teal-600/10 transition-all active:scale-[0.98]"
          >
